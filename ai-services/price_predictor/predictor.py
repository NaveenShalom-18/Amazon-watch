...
_GRADE_MULTIPLIER = {"A": 0.80, "B": 0.65, "C": 0.45, "D": 0.25}
...
def _confidence(grade: str, age_years: float, demand_score: float) -> float:
    ...
    demand_conf = 1.0 - abs(demand_score - 50) / 200
...
def predict(req: PricePredictionRequest) -> PricePredictionResponse:
    ...
    summary           = _build_summary(req, recommended, grade_mult, age_decay, demand_adj, depreciation_rate)
